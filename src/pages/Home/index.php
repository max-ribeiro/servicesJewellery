    ...
    <script type="javascript" src="../src/pages/Home/js/script.js"></script>
</head>

<div class="container">
    <h1>Etapa 1</h1>
    <h3>selecione uma das opções abaixo para começar:</h3>
    <ul>
        <a href="./etapa2.php">
            <li class="button-panel">
                <div class="button-icon">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="file-medical" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="svg-inline--fa fa-file-medical fa-w-12 fa-5x">
        ...
        <li class="button-panel" onclick="showSeach();">
            <div class="button-icon">
                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="file-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="svg-inline--fa fa-file-alt fa-w-12 fa-5x">
...
<div id="searchUser" class="modal">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">              
            <div class="center">
                <div class="col-2-ls">
                    <label>Busca:</label><input type="search" class="modal-input" placeholder="Nome Cliente, Numero Ficha, RG, Outro"/>
                </div>
            </div>
        </div>
    </div>
